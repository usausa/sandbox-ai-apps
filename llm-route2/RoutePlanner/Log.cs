...
internal static partial class Log
{
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Route plan LLM response: {response}")]
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "LLM route plan generated. visitCount=[{visitCount}], overtimeMinutes=[{overtime}], windowViolations=[{violations}], unassigned=[{unassigned}]")]
    public static partial void InfoRoutePlanGenerated(this ILogger log, int visitCount, int overtime, int violations, int unassigned);
